...
- `x-go-gen-extra-tags`: adds extra Go field tags to the generated struct field. This is
...
- `x-go-gen-middlewares`: specifies a list of tagged middlewares. These can be specific
  ...
  skipped.
    ...
    ```yaml
    /pets:
      x-go-gen-middlewares: [validateJSON]
      get:
        x-go-gen-middlewares: [limit]
    ```
