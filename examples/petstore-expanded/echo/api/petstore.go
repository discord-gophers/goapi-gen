...
//go:generate go run github.com/discord-gophers/goapi-gen/cmd/oapi-codegen --config=types.cfg.yaml ../../petstore-expanded.yaml
//go:generate go run github.com/discord-gophers/goapi-gen/cmd/oapi-codegen --config=server.cfg.yaml ../../petstore-expanded.yaml
