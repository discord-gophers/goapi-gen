...
//go:generate go run github.com/discord-gophers/goapi-gen/cmd/goapi-gen --config=types.cfg.yaml ../../petstore-expanded.yaml
//go:generate go run github.com/discord-gophers/goapi-gen/cmd/goapi-gen --config=server.cfg.yaml ../../petstore-expanded.yaml
